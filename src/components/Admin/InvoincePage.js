...
const InvoincePage = () => {
    return (
        <Sidebar SidebarName="Invoince Page">
            ...
            <table className="min-w-max w-full table-auto">
              <thead>
                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                  ...
                  <th className="py-3 px-6 text-center">Available Size</th>
                    ...
                    <div className="flex items-center">
                      <div className="mr-2">
                        <img
                          ...
                          src="https://randomuser.me/api/portraits/women/2jpg"
                          alt=""
                        />
                      </div>
                  ...
                  <td className="py-3 px-6 text-center">
                    <div className="flex items-center justify-center">
                      <img
                        ...
                        src="https://randomuser.me/api/portraits/men/1jpg"
                        alt=""
                      />
                      <img
                      ...
                      <img
                        className="w-6 h-6 rounded-full border-gray-200 border -m-1 transform hover:scale-125"
                        src="https://randomuser.me/api/portraits/men/3jpg"
                        alt=""
                      />
                    </div>
                  </td>
